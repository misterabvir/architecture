...
public class ForgotPasswordHandlerTests
{
    ...
    public ForgotPasswordHandlerTests()
    {
        ...
        _handler = new ForgotPassword.Handler(_unitOfWork, _verificationService);
    }
    ...
    {
        //arrange        
        var query = new ForgotPassword.Query("email@address.com");
        ...
        result.Error.Title.Should().Be("ForgotPassword.UserNotFound");
    }
    ...
    public async Task IfEmailExist_ShouldBeReturnSendVerificationResult(SuccessOrError successOrError)
    {
        ...
        var query = new ForgotPassword.Query(user.Email);
